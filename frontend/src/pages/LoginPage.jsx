    ...
    return (
        <div className="flex items-center justify-center h-screen">
            <div className="bg-glass border border-gray-500 rounded-lg p-6 w-7/12 flex flex-col items-center gap-5">
                ...
                <button className="bg-[#343d48] w-full py-2 rounded-md flex items-center gap-2 justify-center flex-wrap mt-5 duration-300 hover:bg-emerald-500 hover:text-white" onClick={ handleLoginWithGitHub }>
